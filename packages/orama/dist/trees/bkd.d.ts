...
export declare function searchByRadius(node: Nullable<Node>, center: Point, radius: number, inclusive?: boolean, sort?: SortGeoPoints): GeoSearchResult[];
export declare function searchByPolygon(root: Nullable<Node>, polygon: Point[], inclusive?: boolean, sort?: SortGeoPoints): GeoSearchResult[];
