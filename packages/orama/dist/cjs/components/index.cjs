...
const _indexJs = require("../../components/index.js");
let _esmCreate;
let _esmInsert;
let _esmRemove;
let _esmSearch;
...
let _esmSave;
let _esmCreateIndex;
_esmCreate = _indexJs.create;
_esmInsert = _indexJs.insert;
_esmRemove = _indexJs.remove;
_esmSearch = _indexJs.search;
_esmSearchByWhereClause = _indexJs.searchByWhereClause;
_esmGetSearchableProperties = _indexJs.getSearchableProperties;
_esmGetSearchablePropertiesWithTypes = _indexJs.getSearchablePropertiesWithTypes;
_esmLoad = _indexJs.load;
_esmSave = _indexJs.save;
_esmCreateIndex = _indexJs.createIndex;
